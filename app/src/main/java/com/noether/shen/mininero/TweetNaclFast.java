...
*/
	...
	public static String base64EncodeToString(byte [] b) {
	  //return Base64.getUrlEncoder().withoutPadding().encodeToString(b); //for java 8
      return Base64.encodeToString(b, Base64.NO_PADDING); //for java 7
	}
	// byte[] Base64.getUrlEncoder().withoutPadding().encode(b);
	
	public static byte[] base64Decode(String s)
    {
	  //return Base64.getUrlDecoder().decode(s); //this for java 8
        return Base64.decode(s, Base64.DEFAULT); //for android (hopefully fine)
	}
